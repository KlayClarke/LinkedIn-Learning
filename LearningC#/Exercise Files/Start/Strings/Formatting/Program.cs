...
namespace Formatting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0:D}, {0:N}, {0:F}, {0:G}", val1); // 1234, 1,234.000, 1234.000, 1234
            Console.WriteLine("{0:E}, {0:N}, {0:F}, {0:G}", val2); // 1.234568E+003, 1,234.568, 1234.568, 1234.5678

            // TODO: Add a number after the format to specify precision
            Console.WriteLine("{0:D6}, {0:N2}, {0:F1}, {0:G3}", val1); // 001234, 1,234.00, 1234.0, 1.23E+03
